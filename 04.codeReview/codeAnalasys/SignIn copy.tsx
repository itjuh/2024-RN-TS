...
// modules related react hooks
import { TouchableOpacity, Text, StyleSheet, SafeAreaView, Dimensions, Image, View, Platform, StatusBar, Alert } from 'react-native';
// modules related react native tags
import  * as KakaoLogin from '@react-native-seoul/kakao-login';
import { KakaoOAuthToken, login } from '@react-native-seoul/kakao-login';
import NaverLogin from '@react-native-seoul/naver-login';
import { GoogleSignin, statusCodes } from '@react-native-google-signin/google-signin';
// labraries related to login
import { getStatusBarHeight } from 'react-native-status-bar-height';
// module calculating the height of the states bar
// import NaverLogin, { NaverLoginResponse, GetProfileResponse } from '@react-native-seoul/naver-login';

// export default funtion SignIn({navigation} : any){
//}
// a function that receives a any type of navigation as a props
export default function SignIn({navigation} : any) {
    // declare a space to store the token value in advance.
    const [kakaoToken, setKakaoToken] = useState('');
    const [naverToken, setNaverToken] = useState('');
    const [googleToken, setGoogleToken] = useState('');

    /* Kakao Login  */
    // code of typeScript version performs asynchronous processing.
    // code recieves an promise object with no returned value.
